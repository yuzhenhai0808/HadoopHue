...
# sphinx-quickstart on Mon Sep 25 08:38:18 2017.
#
...
latex_documents = [
    (main_doc, 'django-auth-ldap.tex', 'django-auth-ldap Documentation',
...
man_pages = [
    (main_doc, 'django-auth-ldap', 'django-auth-ldap Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (main_doc, 'django-auth-ldap', 'django-auth-ldap Documentation',
     author, 'django-auth-ldap', 'One line description of project.',
     'Miscellaneous'),
]
